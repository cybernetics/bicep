    ...
    public class NamespaceTests
    {
        ...
        private OverloadRecord Convert(FunctionOverload overload) =>
            new OverloadRecord(
                ...
                overload.VariableParameter == null ? null : new VariableParameterRecord(overload.VariableParameter.NamePrefix, overload.VariableParameter.Description, overload.VariableParameter.Type.Name),
                overload.Flags,
        ...
        private record VariableParameterRecord(string NamePrefix, string Description, string Type);
    }
}
